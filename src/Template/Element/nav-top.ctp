                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="">
                        <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                            ...
                            <?php
                                echo $this->request->session()->read('Auth.User.username') ? $this->request->session()->read('Auth.User.username') : $this->request->session()->read('Auth.User.username') ? $this->request->session()->read('Auth.User.username') : 'John Doe';
                                ?>
